    ...
    role: {
      ...
      enum: {
        values: [
          ...
          "staff", "accountant", "parent", "librarian", "counselor", 
          "head teacher", "deputy head teacher", "subject head", 
...
userSchema.methods.generateAuthToken = function () {
  try {
    ...
    const token = signAccessToken({ userId: this._id, role: this.role, email: this.email });
